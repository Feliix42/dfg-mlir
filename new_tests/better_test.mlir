...
dfg.operator @source_wrap inputs () outputs (%val_a: i64, %val_b: i64, %val_c: i64) {
...
dfg.operator @sum_wrap inputs (%a_in: i64, %b_in: i64) outputs (%res_out: i64) {
    %a = dfg.pull %a_in : i64
    %b = dfg.pull %b_in : i64
...
dfg.operator @mul_wrap inputs (%c_in: i64, %d_in: i64) outputs (%res_out: i64) {
    %c = dfg.pull %c_in : i64
    %d = dfg.pull %d_in : i64
...
dfg.operator @sink_wrap inputs (%res_in: i64) outputs () {

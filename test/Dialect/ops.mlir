    ...
    outputs (%a: !dfg.input<ui32>)
{
    loop (%op_a: !dfg.output<ui32>) {
        %inp1 = dfg.pull %op_a : ui32 from !dfg.output<ui32>
        %inp2 = dfg.pull %op_b : ui32 from !dfg.output<ui32>
        ...
        dfg.push(%result) %a : ui32 to !dfg.input<ui32>
    }
}
    ...
    outputs(%op_b: !dfg.input<ui32>)
{
    ...
    dfg.push(%b) %op_b : ui32 to !dfg.input<ui32>
}
...
func.func @run_dfg(%op_a: ui32) -> ui32 {
    ...
    // inputs
    dfg.push(%op_a) %op_a_in : ui32 to !dfg.input<ui32>
    ...
    %res = dfg.pull %res_out : ui32 from !dfg.output<ui32>
